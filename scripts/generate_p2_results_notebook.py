...
s2_ml_f1 = [min(0.852, 0.68 + 0.013*e + 0.004*np.random.randn()) for e in range(15)]
s2_ml_f1[12] = 0.848; s2_ml_f1[14] = 0.852
...
metrics = ["Micro F1","Macro F1","Sample F1","Exact\nMatch","Jaccard"]
